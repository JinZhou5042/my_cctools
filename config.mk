# Generated at Mon Oct  2 18:03:06 EDT 2023 by jzhou24@cclws22.cse.nd.edu

CCTOOLS_HOME=/afs/crc.nd.edu/user/j/jzhou24/cctools
CCTOOLS_INSTALL_DIR=/afs/crc.nd.edu/user/j/jzhou24/miniconda3/envs/cctools-dev
...
CCTOOLS_BASE_CCFLAGS=-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /afs/crc.nd.edu/user/j/jzhou24/miniconda3/envs/cctools-dev/include -D__EXTENSIONS__ -D_LARGEFILE64_SOURCE -D__LARGE64_FILES -Wall -Wextra -Wno-unused-result -fPIC -Wno-unused-parameter -Wno-unknown-pragmas -Wno-deprecated-declarations -Wno-unused-const-variable -DHAS_LIBREADLINE -DHAS_TLS_method -DHAS_OPENSSL -DHAS_PPOLL -DHAVE_GMTIME_R -DHAVE_FDATASYNC -DHAS_ISNAN -DHAVE_ISNAN -DSQLITE_HAVE_ISNAN -DHAVE_LOCALTIME_R -DHAS_OPENAT -DHAS_PREAD -DUSE_PREAD -DUSE_PREAD64 -DHAS_PWRITE -DUSE_PWRITE -DUSE_PWRITE64 -DHAVE_STRCHRNUL -DHAS_STRSIGNAL -DHAS_USLEEP -DHAVE_USLEEP -DHAS_UTIME -DHAVE_UTIME -DHAS_UTIMENSAT -DHAS_SYS_XATTR_H -DHAS_IFADDRS -DHAS_INTTYPES_H -DHAVE_INTTYPES_H -DHAS_STDINT_H -DHAVE_STDINT_H -DHAS_SYS_STATFS_H -DHAS_SYS_STATVFS_H -DHAS_SYS_VFS_H -DBUILD_DATE='"2023-10-02 18:03:06 -0400"' -DBUILD_HOST='"cclws22.cse.nd.edu"' -DBUILD_USER='"jzhou24"' -DCCTOOLS_COMMIT='""' -DCCTOOLS_CONFIGURE_ARGUMENTS='"--with-base-dir /afs/crc.nd.edu/user/j/jzhou24/miniconda3/envs/cctools-dev --prefix /afs/crc.nd.edu/user/j/jzhou24/miniconda3/envs/cctools-dev"' -DCCTOOLS_CPU_X86_64 -DCCTOOLS_CVMFS_BUILD_FLAGS='" "' -DCCTOOLS_OPSYS_LINUX -DCCTOOLS_RELEASE_DATE='"2023-10-02 18:03:06 -0400"' -DCCTOOLS_SOURCE='"DEVELOPMENT"' -DCCTOOLS_SYSTEM_INFORMATION='"Linux cclws22.cse.nd.edu 4.18.0-477.21.1.el8_8.x86_64 \#1 SMP Thu Jul 20 08:38:27 EDT 2023 x86_64 x86_64 x86_64 GNU/Linux"' -DCCTOOLS_VERSION='"8.0.0 DEVELOPMENT"' -DCCTOOLS_VERSION_MAJOR=8 -DCCTOOLS_VERSION_MICRO=0 -DCCTOOLS_VERSION_MINOR=0 -DINSTALL_PATH='"/afs/crc.nd.edu/user/j/jzhou24/miniconda3/envs/cctools-dev"' -D_GNU_SOURCE -D_REENTRANT -g
