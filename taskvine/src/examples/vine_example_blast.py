...
def plot_performance(log_dir, task_name):
    ...
    print(f"Plotting the scheduling performance of {task_name} ...")
    ...
    plt.tight_layout()
    save_png = os.path.join(log_dir, 'task_dispatch_performance.png')
...
with all the same tasks on the worker.""",
    ...
    print(f"Total time cost: {time.time() - manager_start_time:.2f}s including manager starting time: {tasks_start_time - manager_start_time:.2f}")
